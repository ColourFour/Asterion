...
export function ProfileForm({ profile, initialProfile, lockedClassFields = false, onSave }: ProfileFormProps) {
  ...
  return (
    ...
    >
      ...
      {lockedClassFields ? <p className="claim-state-message">Class details came from the claimed roster slot.</p> : null}
      <label>
        Character name

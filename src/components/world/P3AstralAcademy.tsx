    ...
    >
      ...
      {createPortal(
        ...
        >
          ...
          <p className="node-popover-goal">{isFieldGuideOnly ? 'Field Guide is available. Skill Practice, Exam Training, and Guardian are locked for this class.' : regionLearningSummary?.nextAction.explanation ?? goal.label}</p>
        </div>,
        document.body,
      )}
    </article>

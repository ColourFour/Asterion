...
export const AUTHORED_SKILL_CHECK_ITEMS: SkillCheckItem[] = [
  ...
  },
  {
    ...
    prompt: 'When dividing $x^3-6x^2+11x-6$ by $x-1$, what is the first quotient term?',
    inputType: 'multiple_choice',
    validationMode: 'deterministic',
    expectedOptionIds: ['x2'],
    options: [
      { id: 'x2', label: '$x^2$' },
      { id: 'minus-6x', label: '$-6x$' },
      { id: 'x3', label: '$x^3$' },
      { id: 'one', label: '$1$' },
    ],
    complexity: 'foundation',
    hints: {
      nudge: 'Start with leading term divided by leading term.',
      methodCue: 'Compute $x^3\\div x$.',
      firstStep: '$x^3\\div x=x^2$.',
    },
    workedRoute: [
      'Long division starts with the largest term.',
      '$x^3$ divided by $x$ is $x^2$.',
      'That is the first term in the quotient.',
    ],
  ...
  },
  {
    ...
    complexity: 'foundation',
    hints: {
      nudge: 'Use the linear term $nu$.',
      methodCue: 'Here $n=3$ and $u=-2x$.',
      firstStep: '$3(-2x)=-6x$.',
    },
    workedRoute: [
      'The linear term in $(1+u)^n$ is $nu$.',
      'Here $u=-2x$ and $n=3$.',
      'So the coefficient of $x$ is $-6$.',
    ],
    sourceTypes: ['authored', 'quick-check contract', 'teaching snippet'],
    sourceRefs: sourceRefs({
      quickCheckContractIds: ['p3-binomial-term-001-qc'],
      teachingSnippetIds: ['p3-binomial-term-001'],
    }),
    review: review(),
  },
  {
  ...
  },
  {
    ...
    fieldGuideSubtopicId: 'log_laws',
    skillId: 'p3_log_laws_equations',
    prompt: 'Write $2\\ln x-\\ln(x+1)$ as a single logarithm.',
    inputType: 'multiple_choice',
    validationMode: 'deterministic',
    expectedOptionIds: ['correct'],
    options: [
      { id: 'correct', label: '$\\ln\\left(\\frac{x^2}{x+1}\\right)$' },
      { id: 'missing-power', label: '$\\ln\\left(\\frac{2x}{x+1}\\right)$' },
      { id: 'sum-split', label: '$\\ln(x^2-x-1)$' },
      { id: 'product', label: '$\\ln(x^2(x+1))$' },
    ],
    complexity: 'core',
    hints: {
      nudge: 'Move the coefficient into a power before combining.',
  ...
  },
  {
    ...
    prompt: 'For $y=Ae^{kx}$, choose the linear form suitable for plotting $\\ln y$ against $x$.',
    inputType: 'multiple_choice',
    validationMode: 'deterministic',
    expectedOptionIds: ['correct'],
    options: [
      { id: 'correct', label: '$\\ln y=\\ln A+kx$' },
      { id: 'no-ln-a', label: '$\\ln y=A+kx$' },
      { id: 'power-form', label: '$\\ln y=\\ln A+k\\ln x$' },
      { id: 'inverse', label: '$y=\\ln A+ke^x$' },
    ],
    complexity: 'foundation',
    hints: {
      nudge: 'Take logs of the whole equation.',
  ...
  },
  {
    ...
    fieldGuideSubtopicId: 'log_linearisation',
    skillId: 'p3_log_linearisation',
    prompt: 'Linearise $y=4e^{2x}$ by taking natural logs.',
    inputType: 'multiple_choice',
    validationMode: 'deterministic',
    expectedOptionIds: ['correct'],
    options: [
      { id: 'correct', label: '$\\ln y=\\ln4+2x$' },
      { id: 'no-ln-four', label: '$\\ln y=4+2x$' },
      { id: 'power-form', label: '$\\ln y=\\ln4+2\\ln x$' },
      { id: 'not-linear', label: '$\\ln y=4e^{2x}$' },
    ],
    complexity: 'challenge',
    hints: {
      nudge: 'Apply product and exponential log laws.',

export const LOGARITHM_OBSERVATORY_TOPIC_ORDER = [
  'log_graph_inverse',
  'log_laws',
  'log_e_natural_logs',
...
export type LogarithmObservatoryTopicId = typeof LOGARITHM_OBSERVATORY_TOPIC_ORDER[number];

export interface LogarithmObservatoryPracticeAlignment {
  topicId: LogarithmObservatoryTopicId;
...
export const LOGARITHM_OBSERVATORY_SKILL_PRACTICE_ALIGNMENT: LogarithmObservatoryPracticeAlignment[] = [
  {
...
export const LOGARITHM_OBSERVATORY_QUARANTINED_RUNTIME_PRACTICE_IDS = [
...
export const LOGARITHM_OBSERVATORY_QUARANTINE_RECOMMENDATION =
  'Keep the old log-calculus material as non-runtime future-review content until a Calculus Cliffs contract explicitly accepts mixed log/exponential calculus practice.';

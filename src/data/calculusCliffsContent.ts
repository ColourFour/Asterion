export const CALCULUS_CLIFFS_TOPIC_ORDER = [
...
export type CalculusCliffsTopicId = typeof CALCULUS_CLIFFS_TOPIC_ORDER[number];
...
export const CALCULUS_CLIFFS_SKILL_PRACTICE_ALIGNMENT: CalculusCliffsPracticeAlignment[] = [
  {
    ...
    authoringNote: 'Runtime practice is typed and teacher-reviewed. Log graphs and log-law-only prompts remain in Logarithm Observatory.',
  },
  {
  ...
  },
  {
    ...
    authoringNote: 'Runtime keeps identity manipulation out of this topic; trig identities remain in Trigonometry Spire.',
  },
  {

  ...
  },
  {
    ...
    markPoints: [
      ...
      },
      {
        ...
        label: 'Conclusion',
        answerType: 'exact-text',
        acceptedAnswers: ['yes', 'x-2 is a factor'],
        riskFlags: [...algebra],
      },
    ],
  },
    ...
    markPoints: [
      {
        ...
        answerType: 'exact-text',
        acceptedAnswers: ['log_a 16', 'log_a(16)', '\\log_a 16', '\\log_a(16)'],
        riskFlags: [...logs],
      },
    ],
  },
    ...
    markPoints: [
      {
        ...
        label: 'Value of $x$',
        answerType: 'expression-text',
        acceptedAnswers: ['1/2ln5', '(ln5)/2', 'ln5/2', 'x=ln5/2', 'x=(ln5)/2'],
        riskFlags: [...logs],
      },
    ],
  },
    ...
    markPoints: [
      {
        ...
        label: '$\\frac{dy}{dx}$',
        answerType: 'expression-text',
        acceptedAnswers: ['12x^3-2', 'dy/dx=12x^3-2'],
        riskFlags: [...diff],
      },
    ],
  },
    ...
    markPoints: [
      {
        ...
        label: '$\\frac{dy}{dx}$',
        answerType: 'expression-text',
        acceptedAnswers: ['10(2x+1)^4', 'dy/dx=10(2x+1)^4'],
        riskFlags: [...diff],
      },
    ],
  },
    ...
    markPoints: [
      {
        ...
        label: 'Derivative',
        answerType: 'expression-text',
        acceptedAnswers: ['3x^2-3', 'dy/dx=3x^2-3'],
        riskFlags: [...diff],
      },
      {
        id: 'c02-x-values',
      ...
      },
      {
        ...
        answerType: 'exact-text',
        acceptedAnswers: ['(-1,2), (1,-2)', '(-1, 2), (1, -2)', '(1,-2), (-1,2)', '(1, -2), (-1, 2)'],
        riskFlags: [...diff],
      },
    ],
  },
  {
    ...
    markPoints: [
      ...
      },
      {
        ...
        label: 'Integral',
        answerType: 'expression-text',
        acceptedAnswers: ['(3x^2+1)^5/5+C', '1/5(3x^2+1)^5+C'],
        riskFlags: [...integration],
      },
    ],
  },
  {
    ...
    markPoints: [
      ...
      },
      {
        ...
        label: 'Magnitude',
        answerType: 'expression-text',
        acceptedAnswers: ['sqrt17', '\\sqrt17', '\\sqrt(17)'],
        riskFlags: [...vectors],
      },
    ],
  },

...
const m1Topics: CourseSeedTopic[] = [
  ...
  {
    courseId: 'm1',
    id: 'm1-newton-laws-constant-acceleration',
    slug: 'newtons-laws-constant-acceleration',
    syllabusRef: '9709 M1 4.4',
    title: "Newton's Laws: Constant Acceleration",
    shortTitle: 'Newton constant',
    description: 'Apply $F=ma$ to particles and connected bodies when acceleration is constant over the modelled interval.',
    headerFormula: 'F=ma,\\quad a=\\text{constant}',
    formulas: ['$F=ma$', '$R=mg$ on a horizontal surface when no other vertical forces act', '$v=u+at$ when acceleration is constant'],
    studentGoals: [
      'Draw force diagrams for accelerating particles.',
      'Write equations of motion along the direction of constant acceleration.',
      'Model connected particles with common acceleration and shared tension.',
    ],
    keyIdeas: [
      'Resultant force, not a single force, equals $ma$.',
      'Constant acceleration allows Newton equations to connect directly with suvat formulae.',
    ...
    workedMethod: [
      ...
      'Solve the equations simultaneously for constant acceleration and tension or force.',
    ],
    commonMistakes: [
      ...
      'Using suvat before checking that acceleration is constant over the interval.',
    ],
    selfChecks: [
      ...
      'When can a Newton equation be followed by a suvat calculation?',
    ],
    examStyle: [
    ...
    practiceHook: 'Seed practice will use one-particle $F=ma$ before connected-particle systems with constant acceleration.',
    examTrainingHook: 'Later exam training should make students identify the model assumptions behind shared constant acceleration.',
    fieldGuideSections: [
      {
        id: 'm1-newton-constant-resultant',
      ...
      {
        id: 'm1-newton-constant-connected',
  ...
  {
    courseId: 'm1',
    id: 'm1-newton-laws-variable-acceleration',
    slug: 'newtons-laws-variable-acceleration',
    syllabusRef: '9709 M1 4.4',
    title: "Newton's Laws: Variable Acceleration",
    shortTitle: 'Newton variable',
    description: 'Apply $F=ma$ when acceleration varies with time, displacement, or velocity, using calculus relationships from kinematics.',
    headerFormula: 'F=m\\frac{dv}{dt},\\quad a=v\\frac{dv}{dx}',
    formulas: ['$F=ma$', '$a=\\frac{dv}{dt}$', '$v=\\frac{dx}{dt}$', '$a=v\\frac{dv}{dx}$'],
    studentGoals: [
      'Recognise when acceleration is not constant and suvat formulae are not valid.',
      'Use $a=dv/dt$ or $a=v\\,dv/dx$ to connect force with velocity or displacement.',
      'Integrate a variable-acceleration equation with correct limits or initial conditions.',
    ],
    keyIdeas: [
      'Newton’s second law still uses resultant force, but $a$ may be a function instead of a constant.',
      'The calculus form depends on what the acceleration is written in terms of.',
      'Initial conditions turn a general velocity or displacement expression into a particular motion model.',
    ],
    workedMethod: [
      'Draw the force diagram and write the resultant force equation.',
      'Replace $a$ with $dv/dt$ when the model is time-based, or with $v\\,dv/dx$ when it is displacement-based.',
      'Separate variables or integrate with limits using the given initial condition.',
      'Check whether the final answer asks for velocity, displacement, time, force, or acceleration.',
    ],
    commonMistakes: [
      'Using suvat in a model where acceleration varies.',
      'Choosing $dv/dt$ when the equation is easier in terms of displacement.',
      'Integrating without applying the initial condition.',
    ],
    selfChecks: [
      'What clue tells you acceleration is varying rather than constant?',
      'When is $a=v\\,dv/dx$ more useful than $a=dv/dt$?',
      'Why must an initial condition be used after integration?',
    ],
    examStyle: [
      'Variable-acceleration questions often start like a Newton-law model, then require calculus to continue.',
      'Expect method marks for the correct acceleration form and for applying limits or initial conditions.',
    ],
    practiceHook: 'Seed practice will separate constant-acceleration recognition from variable-acceleration calculus setup.',
    examTrainingHook: 'Later exam training should require students to state why suvat is not valid before using calculus.',
    fieldGuideSections: [
      {
        id: 'm1-newton-variable-form',
        title: 'Choose the acceleration form',
        purpose: 'Match the calculus relationship to the variables in the question.',
        bullets: [
          'Use $a=dv/dt$ when acceleration or force is time-based.',
          'Use $v=dx/dt$ when velocity controls displacement over time.',
          'Use $a=v\\,dv/dx$ when acceleration or force is displacement-based.',
        ],
      },
      {
        id: 'm1-newton-variable-integrate',
        title: 'Integrate with conditions',
        purpose: 'Turn a differential relationship into a usable motion result.',
        bullets: [
          'Separate variables where possible.',
          'Use limits or add a constant of integration.',
          'Apply the initial condition before answering the final question.',
        ],
      },
    ],
  },

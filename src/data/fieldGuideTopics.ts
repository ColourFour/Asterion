...
export const FIELD_GUIDE_TOPICS_BY_REGION: Record<string, FieldGuideTopic[]> = {
  'algebra': [
    {
      ...
      examples: [
        {
          title: 'Repeated block as a substitution',
          prompt: 'Solve $(x^2+2x)^2-5(x^2+2x)+6=0$ without expanding the quartic.',
          workedLines: [
            'The repeated block is $x^2+2x$, so set $u=x^2+2x$.',
            'The equation becomes $u^2-5u+6=0=(u-2)(u-3)$.',
            'So $x^2+2x=2$ or $x^2+2x=3$.',
            '$x^2+2x-2=0$ gives $x=-1\\pm\\sqrt3$.',
            '$x^2+2x-3=0$ gives $x=1$ or $x=-3$.',
          ],
          patternTitle: 'Inspect the form first',
          patternRows: [
            { from: 'repeated expression', move: 'substitute', to: 'a smaller equation' },
            { from: 'common factor', move: 'factor', to: 'visible product or cancellation' },
            { from: 'rational expression', move: 'preserve restrictions', to: 'cancel only after stating excluded values' },
            { from: 'already factorised equation', move: 'use', to: 'zero-product rule' },
          ],
          tryPrompt: 'Solve $(x^2-1)(x+4)=0$ without expanding.',
          tryScaffold: ['Inspect the product', 'Use zero-product rule', 'Factor the difference of squares', 'State all roots'],
          tryWorkedLines: [
            'Use the product structure: $x^2-1=0$ or $x+4=0$.',
            '$x^2-1=(x-1)(x+1)$, so $x=1$ or $x=-1$.',
            '$x+4=0$ gives $x=-4$.',
          ],
          tryResult: '$$ x=-4,\\ -1,\\ 1 $$',
          takeaway: [
            'Factor, substitute, rearrange, or preserve a factor when the form is already useful.',
            'Avoid unnecessary expansion when it hides the repeated block or denominator restriction.',
            'Skill Practice starts with structure-recognition checks, then moves to cancellable factors and product equations.',
          ],
          result: '$$ x=-3,\\ 1,\\ -1-\\sqrt3,\\ -1+\\sqrt3 $$',
        },
      ],
    },
    {
    ...
    {
      id: 'algebra_discriminant_root_conditions',
      marker: 'D',
      title: 'Discriminant and Root Conditions',
      purpose: 'Use $b^2-4ac$ to decide root conditions before solving.',
      skillIds: ['algebra_discriminant_root_conditions'],
      preview: '$$ D=b^2-4ac $$',
      description: 'When a question asks about real roots, repeated roots, no real roots, or tangency, the discriminant is usually the shortest route.',
      supportNote: 'This bridge covers the P3 root-condition use of the discriminant only. It does not add a wider quadratic-revision curriculum.',
      examples: [
        {
          title: 'Repeated-root parameter',
          prompt: 'Find the values of $k$ for which $x^2+kx+9=0$ has a repeated root.',
          workedLines: [
            'For $ax^2+bx+c=0$, the discriminant is $D=b^2-4ac$.',
            'A repeated root means $D=0$.',
            'Here $a=1$, $b=k$, and $c=9$, so $k^2-4(1)(9)=0$.',
            '$k^2-36=0$, hence $k=\\pm6$.',
          ],
          patternTitle: 'Root-condition meanings',
          patternRows: [
            { from: '$D>0$', move: 'means', to: 'two distinct real roots' },
            { from: '$D=0$', move: 'means', to: 'one repeated real root' },
            { from: '$D<0$', move: 'means', to: 'no real roots' },
            { from: 'tangent intersection', move: 'often gives', to: '$D=0$ after forming a quadratic' },
          ],
          tryPrompt: 'Use the discriminant to state the number of real roots of $2x^2-3x+5=0$.',
          tryScaffold: ['Identify a, b, c', 'Calculate D', 'Use the sign of D', 'State the root condition'],
          tryWorkedLines: [
            '$a=2$, $b=-3$, and $c=5$.',
            '$D=(-3)^2-4(2)(5)=9-40=-31$.',
            'Since $D<0$, there are no real roots.',
          ],
          tryResult: '$$ D=-31,\\quad \\text{no real roots} $$',
          takeaway: [
            'Write the discriminant condition before solving for a parameter.',
            'Check the inequality direction: repeated roots use $D=0$, not $D>0$.',
            'Mark schemes usually award method credit for writing $D$, applying the correct condition, solving it, and interpreting the result.',
            'Skill Practice checks the formula, the root-condition meaning, and the repeated-root parameter move.',
          ],
          result: '$$ k=-6\\quad\\text{or}\\quad k=6 $$',
        },
      ],
    },
    {
  ...
  'complex-numbers': [
    {
      ...
      supportNote: 'Support skill: this rehearses complex-number algebra before P3 modulus, argument, loci, and roots. It is not exam-readiness evidence by itself.',
      examples: [
        {
  ...
  'differentiation': [
    ...
    },
    {
      ...
      marker: 'm',
      title: 'Stationary Points, Tangents, and Normals',
      purpose: 'Turn a derivative into the gradient information the question asks for.',
      ...
      examples: [
        {
          ...
          prompt: 'For $y=x^2+1$ at $x=3$, find the tangent and normal equations, and state whether the point is stationary.',
          workedLines: [
            'Differentiate first: $\\frac{dy}{dx}=2x$.',
            'At $x=3$, the point is $(3,10)$ and the tangent gradient is $m=6$.',
            'Since $m\\ne0$, the point is not stationary.',
            'The tangent is $y-10=6(x-3)$.',
            'The normal gradient is the negative reciprocal, $m_n=-\\frac16$, so the normal is $y-10=-\\frac16(x-3)$.',
          ],
          patternTitle: 'Exam move sequence',
          patternRows: [
            { from: 'curve equation', move: 'differentiate', to: '$dy/dx$' },
            { from: 'given point', move: 'substitute', to: 'gradient and coordinates' },
            { from: 'stationary point', move: 'solve', to: '$dy/dx=0$' },
            { from: 'tangent gradient $m$', move: 'normal gradient', to: '$-1/m$ when $m\\ne0$' },
            { from: 'point + gradient', move: 'line equation', to: '$y-y_1=m(x-x_1)$' },
          ],
          tryPrompt: 'Find the normal line to $y=x^2$ at $x=2$.',
          tryScaffold: ['Differentiate', 'Substitute $x=2$', 'Use negative reciprocal', 'Form the line equation'],
          tryWorkedLines: [
            '$\\frac{dy}{dx}=2x$, so the tangent gradient at $x=2$ is $4$.',
            'The point is $(2,4)$.',
            'The normal gradient is $-\\frac14$.',
          ],
          tryResult: '$$ y-4=-\\frac14(x-2) $$',
          takeaway: [
            'A stationary point has tangent gradient zero.',
            'The negative reciprocal normal rule needs a non-zero finite tangent gradient; if the tangent is horizontal, the normal is vertical.',
            'Skill Practice uses reviewed stationary, tangent, and normal prompts after this bridge.',
          ],
          result: '$$ \\text{tangent: }y-10=6(x-3),\\quad \\text{normal: }y-10=-\\frac16(x-3) $$',
        },
      ],
    },
    {
      ...
      examples: [
        {
          ...
          workedLines: [
            'Recognition cue: $\\tan^{-1}(u)$ or $\\arctan u$ is an inverse-tangent derivative form.',
            'Use $\\frac{d}{dx}\\tan^{-1}(u)=\\frac{u\\prime}{1+u^2}$.',
            'Here $u=3x$, so $u\\prime=3$.',
            'Therefore $\\frac{dy}{dx}=\\frac{3}{1+9x^2}$.',
          ],
          patternTitle: 'Official-scope support',
          patternRows: [
            { from: '$\\tan^{-1}x$', move: 'differentiate', to: '$\\frac1{1+x^2}$' },
            { from: '$\\tan^{-1}(u)$', move: 'chain rule', to: '$\\frac{u\\prime}{1+u^2}$' },
            { from: 'exam follow-through', move: 'then use', to: 'gradient, tangent, or stationary condition' },
          ],
          tryPrompt: 'Differentiate $\\tan^{-1}(2x-1)$.',
          tryScaffold: ['Identify u', 'Find u prime', 'Use 1 plus u squared', 'Do not use sec squared'],
          tryWorkedLines: [
            'Let $u=2x-1$, so $u\\prime=2$.',
            'Use $\\frac{u\\prime}{1+u^2}$.',
            'This gives $\\frac{2}{1+(2x-1)^2}$.',
          ],
          tryResult: '$$ \\frac{2}{1+(2x-1)^2} $$',
          takeaway: [
            '$\\tan^{-1}x$ means inverse tangent here, not $1/\\tan x$ and not a power of $-1$.',
            'Do not use $\\sec^2x$; that is the derivative of $\\tan x$, not $\\tan^{-1}x$.',
            'Skill Practice keeps broad inverse-trig curriculum out; this support is for P3 differentiation follow-through when inverse tangent appears.',
          ],
          result: '$$ \\frac{dy}{dx}=\\frac{3}{1+9x^2} $$',
        },
      ],
    },
    {
      ...
      examples: [
        {
          ...
          prompt: 'Given $\\frac{3x}{(x-1)(x+2)}=\\frac1{x-1}+\\frac2{x+2}$, integrate the rational function.',
          workedLines: [
      ...
      examples: [
        {
          ...
          workedLines: [
            ...
            'Write the bracketed bound line: $\\left[x^2+x\\right]_1^3$.',
            'Substitute upper then lower: $(9+3)-(1+1)$.',
            'So the exact value is $10$.',
          ],
          patternTitle: 'Definite-integral move sequence',
          patternRows: [
            { from: 'definite integral', move: 'write as', to: '$\\left[F(x)\\right]_a^b$' },
            { from: 'upper bound', move: 'subtract', to: 'lower bound' },
            { from: 'final value', move: 'does not need', to: '$+c$' },
          ],
          tryPrompt: 'Evaluate $\\int_0^2 3x^2\\,dx$.',
          tryScaffold: ['Find antiderivative', 'Write bracketed bounds', 'Substitute upper', 'Subtract lower'],
          tryWorkedLines: [
            'An antiderivative is $x^3$.',
            'Use brackets: $\\left[x^3\\right]_0^2$.',
            'Upper minus lower gives $8-0$.',
          ],
          tryResult: '$$ 8 $$',
          takeaway: [
            'Common trap: forgetting brackets can make only the last term receive the limit.',
            'Mark-scheme move: show the antiderivative, bracketed bounds, and upper-minus-lower line.',
            'Skill Practice includes deterministic definite-integral bridge checks.',
          ],
          result: '$$ 10 $$',
        },
      ],
      ...
      examples: [
        {
          ...
          workedLines: [
            'On this interval, $x+2$ is above $x^2$.',
            'Area is $\\int_0^2\\left((x+2)-x^2\\right)\\,dx$.',
            'An antiderivative is $\\frac12x^2+2x-\\frac13x^3$.',
            'Substituting $2$ and $0$ gives $2+4-\\frac83=\\frac{10}{3}$.',
          ],
          patternTitle: 'Area expression choice',
          patternRows: [
            { from: 'area under positive curve', move: 'use', to: '$\\int_a^b y\\,dx$' },
            { from: 'area between curves', move: 'use', to: '$\\int_a^b(\\text{upper}-\\text{lower})\\,dx$' },
            { from: 'curve crossing', move: 'may create', to: 'bounds or split intervals' },
          ],
          tryPrompt: 'On $0\\le x\\le1$, find the area between $y=2$ and $y=x$.',
          tryScaffold: ['Choose upper minus lower', 'Integrate', 'Substitute bounds', 'Check positivity'],
          tryWorkedLines: [
            '$2$ is above $x$ on $0\\le x\\le1$.',
            'Area is $\\int_0^1(2-x)\\,dx$.',
            '$\\left[2x-\\frac12x^2\\right]_0^1=\\frac32$.',
          ],
          tryResult: '$$ \\frac32 $$',
          takeaway: [
            'Common trap: a negative area answer usually means the upper and lower curves were reversed, or the interval needs splitting.',
            'Bounds may be given, or found from intersections before integrating.',
            'Skill Practice includes authored area setup checks so area is not treated as signed integral only.',
          ],
          result: '$$ \\frac{10}{3} $$',
        },
      ],
      ...
      examples: [
        {
          ...
          workedLines: [
            'Replace the infinite bound: $\\int_0^\\infty e^{-2x}\\,dx=\\lim_{b\\to\\infty}\\int_0^b e^{-2x}\\,dx$.',
            'An antiderivative is $-\\frac12e^{-2x}$.',
            'So $\\left[-\\frac12e^{-2x}\\right]_0^b=-\\frac12e^{-2b}+\\frac12$.',
            'As $b\\to\\infty$, $e^{-2b}\\to0$, so the value is $\\frac12$.',
          ],
          patternTitle: 'Limit-style check',
          patternRows: [
            { from: 'infinite bound', move: 'replace by', to: 'a limit' },
            { from: 'decaying exponential', move: 'tends to', to: '$0$' },
            { from: 'non-finite limit', move: 'means', to: 'no finite value' },
          ],
          tryPrompt: 'Evaluate $\\int_0^\\infty e^{-x}\\,dx$.',
          tryScaffold: ['Replace infinity by b', 'Find antiderivative', 'Substitute bounds', 'Take the limit'],
          tryWorkedLines: [
            '$\\int_0^\\infty e^{-x}\\,dx=\\lim_{b\\to\\infty}\\int_0^b e^{-x}\\,dx$.',
            'An antiderivative is $-e^{-x}$.',
            '$\\left[-e^{-x}\\right]_0^b=-e^{-b}+1\\to1$.',
          ],
          tryResult: '$$ 1 $$',
          takeaway: [
            'Common trap: do not substitute $\\infty$ directly into the antiderivative.',
            'This bridge is limited to source-backed P3-style convergent improper evaluations.',
            'Skill Practice includes one narrow limit-style bridge item, not a broad improper-integral course.',
          ],
          result: '$$ \\frac12 $$',
        },
      ],

...
export const FIELD_GUIDE_TOPICS_BY_REGION: Record<string, FieldGuideTopic[]> = {
  ...
  'trig-observatory': [
    ...
    },
    {
      ...
      marker: 'R',
      title: 'R-Form',
      purpose: 'Rewrite $a\\sin x+b\\cos x$ as one shifted trig function.',
  ...
  'complex-harbor': [
    {
      ...
      purpose: 'Work safely with $a+bi$ and its conjugate.',
  ...
  'calculus-cliffs': [
    ...
    },
    {
      ...
      purpose: 'Find $\\frac{dy}{dx}$ from derivatives with respect to a parameter.',

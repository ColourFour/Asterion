export const ITERATION_FORGE_TOPIC_ORDER = [
...
export type IterationForgeTopicId = typeof ITERATION_FORGE_TOPIC_ORDER[number];
...
export const ITERATION_FORGE_QUARANTINED_RUNTIME_PRACTICE_IDS = [

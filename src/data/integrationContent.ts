export const INTEGRATION_TOPIC_ORDER = [
...
export type IntegralTerracesTopicId = typeof INTEGRATION_TOPIC_ORDER[number];
...
export const INTEGRAL_TERRACES_SKILL_PRACTICE_ALIGNMENT: IntegralTerracesPracticeAlignment[] = [
  ...
  },
  {
    ...
    authoringNote: 'Runtime keeps these as integration prompts. Trig differentiation remains in Differentiation and trig equation solving remains in Trigonometry.',
  },
  {
    ...
    authoringNote: 'Identity manipulation is present only as support for integration; pure identity work remains in Trigonometry.',
  },
  {
    ...
    authoringNote: 'Runtime integration items now live in Integration. Algebra keeps decomposition-only prompts as algebra.',
  },
  {
    ...
    authoringNote: 'Runtime uses arctan-form integration only; inverse-trig derivative derivations remain supporting context in Differentiation.',
  },
  {
    ...
    authoringNote: 'Runtime includes one definite changed-limits item. Integration by parts remains a separate Integration topic.',
  },
  {

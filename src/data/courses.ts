...
export const COURSES: CourseMetadata[] = [
  {
    ...
    shortName: 'P1',
    shortDescription: 'Core algebra, functions, coordinate geometry, sequences, trigonometry, differentiation, and integration foundations.',
  ...
  },
  {
    ...
    shortName: 'M1',
    shortDescription: 'Forces, motion, Newtonian modelling, momentum, and connected-particle mechanics.',

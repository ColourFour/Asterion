...
export const visualSupportSources: VisualSupportSource[] = [
  ...
  },
  {
    ...
    topicIds: ['9709_p3_topic_numerical_solution_of_equations', 'iteration_fixed_point_roots', 'iteration_convergence'],
  ...
  },
  {
    ...
    regionId: 'numerical-mines',
    topicIds: ['9709_p3_topic_numerical_solution_of_equations', 'iteration_change_of_sign', 'iteration_fixed_point_roots'],
    skillIds: ['p3_num_sign_change_graph_evidence', 'p3_num_iteration_formula'],
    pageType: 'field-guide',
    visualKind: 'needs_visual',
    title: 'Iteration Forge root-approximation visual',
    purpose: 'Deferred original visual for sign-change and fixed-point root approximation',
    ...
    status: 'review-required',
    replacementNotes: 'Quarantined for this pass because Newton-Raphson is outside the approved Iteration Forge scope. Replace with an Asterion original static card showing sign-change evidence, iteration steps, and rounding caution.',
  },
  {
    ...
    purpose: 'Deferred original post-reveal support for repeated approximation steps',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/NewtonIteration_Ani.gif',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:NewtonIteration_Ani.gif',
    license: 'CC BY-SA 3.0, via Wikimedia Commons',
    attribution: 'Ralf Pfeifer, Wikimedia Commons',
    ...
    status: 'review-required',
    replacementNotes: 'Quarantined for this pass because Newton-Raphson is outside the approved Iteration Forge scope. Replace with an Asterion original Iteration Forge post-reveal card showing estimate table, recurrence use, convergence checks, and final rounding.',
  },
  {

    ...
    workedExamples: [
      {
        ...
        steps: [
          ...
          'Compute the quadratic term: $\\frac{5\\cdot4}{2}(2x)^2=10\\cdot4x^2=40x^2$.',
        ],
        answer: '$1+10x+40x^2$.',
    ...
    workedExamples: [
      {
        ...
        steps: [
          ...
          'Keep the domain restriction $x>0$.',
        ],
        answer: '$\\ln(5x)$, with $x>0$.',
      ...
      },
      {
        ...
        answer: 'Plot $\\ln y$ against $\\ln x$; gradient $3$, intercept $\\ln2$.',
  ...
  'trig-observatory': {
    ...
    workedExamples: [
      ...
      },
      {
        ...
        steps: [
          'Find the reference angle: $\\sin^{-1}(\\frac12)=\\frac{\\pi}{6}$.',
      ...
      },
      {
        ...
        steps: [
          ...
          'Use $R=\\sqrt{3^2+4^2}=5$ and $\\tan\\alpha=\\frac43$.',
        ],
        answer: '$5\\sin(x+\\alpha)$ where $\\alpha=\\tan^{-1}(\\frac43)$.',
    ...
    workedExamples: [
      {
        ...
        steps: [
          ...
          'The reference angle is $\\tan^{-1}(\\sqrt3)=\\frac{\\pi}{3}$.',
      ...
      },
      {
        ...
        steps: [
          ...
          'Use angles $\\frac{\\pi+2k\\pi}{3}$ for $k=0,1,2$.',
          'This gives angles $\\frac{\\pi}{3}$, $\\pi$, and $\\frac{5\\pi}{3}$.',
        ],
        answer: '$2e^{i\\pi/3}$, $2e^{i\\pi}$, and $2e^{i5\\pi/3}$.',
      ...
      },
      {
        ...
        steps: [
          ...
          'The equation says the distance from this centre is $3$.',
  ...
  'integration-gardens': {
    ...
    workedExamples: [
      ...
      },
      {
        ...
        steps: [
          'Area is $-\\int_0^2 (x^2-4)\\,dx+\\int_2^3 (x^2-4)\\,dx$.',
    ...
    workedExamples: [
      {
        ...
        steps: [
          ...
          'Use the $x$-component: $1+2s=3+t$, so with $s=1$, $t=0$.',
          'Check the $z$-component: $2-s=1+2t$, so $1=1$.',
        ],

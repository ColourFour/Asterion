export const VECTORS_TOPIC_ORDER = [
  'vectors_notation',
...
export type VectorsTopicId = typeof VECTORS_TOPIC_ORDER[number];

export interface VectorsPracticeAlignment {
  topicId: VectorsTopicId;
...
export const VECTORS_SKILL_PRACTICE_ALIGNMENT: VectorsPracticeAlignment[] = [
  {
...
export const VECTORS_OUT_OF_SCOPE_TERMS = [
  'argand',
  'complex number',

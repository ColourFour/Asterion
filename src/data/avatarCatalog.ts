...
export const AVATAR_CATALOG: AvatarItem[] = [
  {
    ...
    description: 'The default v0.3 Astral Academy student body layer.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/base/student-body-a.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
  ...
  },
  {
    ...
    description: 'An alternate v0.3 student body layer for the academy avatar canvas.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/base/student-body-b.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    description: 'A study-ready short hairstyle for the v0.3 avatar set.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/hair/tousled-short.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/hair/neat-side-part.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    description: 'A compact v0.3 hairstyle with a clear HUD silhouette.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/hair/short-crop.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    description: 'A starter bob hairstyle aligned to the v0.3 avatar canvas.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/hair/bob-with-bangs.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/face/confident-smile.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/face/calm-neutral.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    description: 'The v0.3 academy outfit layer for practice and map cameos.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/outfit/school-spirit-tracksuit.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/empty/no-cloak.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
    isEmpty: true,
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/empty/no-accessory.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
    isEmpty: true,
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/empty/no-aura.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
    isEmpty: true,
  },
  {
    ...
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/empty/no-companion.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
    isEmpty: true,
  },
  {
    ...
    description: 'Keep the v0.3 avatar portrait unframed.',
    rarity: 'starter',
    assetPath: '/assets/avatar-v0.3/empty/no-frame.png',
    unlockCondition: { type: 'starter' },
    unlockText: 'Starter item.',
    isEmpty: true,
  },
  {
    ...
    rarity: 'bronze',
    assetPath: '/assets/avatar-v0.3/hair/shoulder-length-straight.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
  ...
  },
  {
    ...
    rarity: 'bronze',
    assetPath: '/assets/avatar-v0.3/face/determined.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
    unlockCondition: { type: 'anyRegionRank', rank: 'Bronze', count: 1 },
    unlockText: 'Reach Bronze in any region.',
  ...
  },
  {
    ...
    rarity: 'silver',
    assetPath: '/assets/avatar-v0.3/hair/low-ponytail.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',
  ...
  },
  {
    ...
    rarity: 'silver',
    assetPath: '/assets/avatar-v0.3/face/focused-soft.png',
    previewPath: '/assets/avatar-v0.3/preview/default-school-spirit.png',

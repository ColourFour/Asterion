...
- Do not treat P1, M1, or S1 draft starter content as final syllabus-contract content without an explicit syllabus audit task.
...
- `src/lib/progressStore.ts`: localStorage-backed progress behavior.

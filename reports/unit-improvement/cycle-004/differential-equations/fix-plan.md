# Fix Plan — Differential Equations — Cycle 4
...
## Files Changed
- src/data/differentialEquationsLearnSteps.ts

## Risk
- Low: copy-only hint change; options and accepted answers are unchanged.
- Low: copy-only prompt change; separation answer is unchanged.

# Fix Plan — Complex Numbers — Cycle 4
...
## Files Changed
- src/data/complexNumbersLearnSteps.ts

## Risk
- Low: copy-only hint change; accepted answers and deterministic checks are unchanged.
- Low: copy-only prompt change; quadrant answer and checks are unchanged.

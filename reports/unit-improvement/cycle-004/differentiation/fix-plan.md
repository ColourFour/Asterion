# Fix Plan — Differentiation — Cycle 4
...
- Make the Differentiation hint point to the method mark
  Status: applied. Applied the exact declared source replacement to 1 occurrence(s).
  File: src/data/differentiationLearnSteps.ts
  Risk: Low: copy-only hint change; options and accepted answers are unchanged.
- Frame differentiation as method choice before calculation
...
## Files Changed
- src/data/differentiationLearnSteps.ts

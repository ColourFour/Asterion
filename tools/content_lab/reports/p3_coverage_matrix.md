...
- `P1_missing_core_support`: 6
- `P2_missing_practice_support`: 21
- `P3_teacher_review_backlog`: 2
- `P4_polish_or_complete`: 10
...
`p3_complex_roots_powers`, `p3_de_forming_context_model`, `p3_diff_implicit_log_exp`, `p3_int_definite_improper_area`, `p3_log_calculus_contexts`, `p3_vec_3d_geometry_modelling`

### P2_missing_practice_support

`p3_alg_discriminant_root_conditions`, `p3_alg_polynomial_remainder_factor`, `p3_alg_structure_rearrangement`, `p3_complex_argand_loci_regions`, `p3_complex_cartesian_conjugate`, `p3_complex_modulus_argument_form`, `p3_de_initial_condition`, `p3_de_separation_setup`, `p3_diff_chain_product_quotient`, `p3_diff_method_selection`, `p3_diff_parametric_gradients`, `p3_diff_stationary_tangent_normal`, `p3_int_method_choice`, `p3_int_parts_substitution`, `p3_log_domain_validation`, `p3_log_linearisation`, `p3_num_accuracy_rounding`, `p3_num_iteration_formula`, `p3_num_sign_change_graph_evidence`, `p3_vec_line_equations_intersections`, `p3_vec_scalar_product_angles`

### P3_teacher_review_backlog

`p3_trig_identity_selection`, `p3_trig_reciprocal_double_angle`

### P4_polish_or_complete

`p3_alg_binomial_terms_coefficients`, `p3_alg_binomial_validity`, `p3_alg_modulus_cases`, `p3_alg_partial_fraction_form`, `p3_log_convert_forms`, `p3_log_exponential_equations`, `p3_log_laws_equations`, `p3_trig_equation_interval`, `p3_trig_quadrant_solutions`, `p3_trig_r_form_compound_angles`
...
| p3_alg_discriminant_root_conditions | Algebra | Algebra Vault | missing_support | 2 | 0 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
...
| p3_alg_partial_fraction_form | Algebra | Algebra Vault | ready_for_review | 6 | 0 | none | P4_polish_or_complete | Teacher review can confirm this row for region-by-region correction planning. |
| p3_alg_polynomial_remainder_factor | Algebra | Algebra Vault | missing_support | 5 | 0 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
| p3_alg_structure_rearrangement | Algebra | Algebra Vault | missing_support | 2 | 0 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
...
| p3_de_separation_setup | Differential equations | Differential Shrine | missing_support | 5 | 0 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
| p3_diff_chain_product_quotient | Differentiation | Calculus Cliffs | needs_teacher_review | 2 | 3 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
| p3_diff_implicit_log_exp | Differentiation | Calculus Cliffs | needs_teacher_review | 1 | 3 | quick_check, warm_up | P1_missing_core_support | Add reviewed snippet, worked-example, or Quick Check support for the missing core support types. |
...
| p3_diff_stationary_tangent_normal | Differentiation | Calculus Cliffs | needs_teacher_review | 2 | 3 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
| p3_int_definite_improper_area | Integration | Integral Terraces | needs_teacher_review | 3 | 2 | quick_check, warm_up | P1_missing_core_support | Add reviewed snippet, worked-example, or Quick Check support for the missing core support types. |
...
| p3_int_partial_fractions | Integration | Integral Terraces | blocked_for_mastery | 0 | 5 | none | P0_blocked_mastery | Find or review clean P3 canonical mastery evidence before claiming mastery. |
...
| p3_log_calculus_contexts | Logarithmic and exponential functions | Logarithm Observatory | needs_teacher_review | 4 | 1 | snippet, worked_example, quick_check, warm_up | P1_missing_core_support | Add reviewed snippet, worked-example, or Quick Check support for the missing core support types. |
...
| p3_num_iteration_formula | Numerical solution of equations | Iteration Forge | missing_support | 4 | 0 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
| p3_num_sign_change_graph_evidence | Numerical solution of equations | Iteration Forge | missing_support | 5 | 0 | warm_up | P2_missing_practice_support | Add reviewed deterministic warm-up support after core teaching support is safe. |
...
| p3_trig_identity_selection | Trigonometry | Trigonometry Spire | needs_teacher_review | 3 | 2 | none | P3_teacher_review_backlog | Keep deferred cases visible and route them through teacher review before export or mastery claims. |
...
| p3_trig_reciprocal_double_angle | Trigonometry | Trigonometry Spire | needs_teacher_review | 4 | 1 | none | P3_teacher_review_backlog | Keep deferred cases visible and route them through teacher review before export or mastery claims. |
...
| --- | ---: | ---: | --- | --- |
| p3_int_partial_fractions | 0 | 5 | all_available_evidence_deferred, mastery_evidence_blocked_by_routing_audit, no_clean_mastery_evidence | Find or review clean P3 canonical mastery evidence before claiming mastery. |

## Deferred Ambiguous Evidence

- Deferred case count: 20
...
| --- | --- | --- | --- | --- |
| p3_diff_chain_product_quotient | 31summer21_q09 | logarithm-grove | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_chain_product_quotient | 33summer21_q08 | integration-gardens | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_chain_product_quotient | 35summer25_q04 | logarithm-grove | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_implicit_log_exp | 31summer21_q09 | logarithm-grove | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_implicit_log_exp | 32autumn21_q09 | logarithm-grove | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_implicit_log_exp | 35autumn25_q04 | logarithm-grove | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_stationary_tangent_normal | 31summer21_q09 | logarithm-grove | calculus-cliffs | ambiguous_part_level_evidence |
| p3_diff_stationary_tangent_normal | 32autumn21_q11 | numerical-mines | calculus-cliffs | ambiguous_part_level_evidence |
...
| p3_int_definite_improper_area | 33summer21_q04 | algebra-forge | integration-gardens | ambiguous_part_level_evidence |
| p3_int_partial_fractions | 31summer21_q10 | algebra-forge | integration-gardens | ambiguous_part_level_evidence |
...
| p3_int_partial_fractions | 33summer21_q04 | algebra-forge | integration-gardens | ambiguous_part_level_evidence |
...
| ---: | --- | --- | ---: | ---: |
| 1 | Integral Terraces | P0_blocked_mastery | 1 | 3 |
| 2 | Calculus Cliffs | P1_missing_core_support | 0 | 5 |
| 3 | Argand Atrium | P1_missing_core_support | 0 | 4 |
| 4 | Differential Shrine | P1_missing_core_support | 0 | 3 |
| 5 | Logarithm Observatory | P1_missing_core_support | 0 | 3 |
| 6 | Vectors Gate | P1_missing_core_support | 0 | 3 |
| 7 | Algebra Vault | P2_missing_practice_support | 0 | 3 |
| 8 | Iteration Forge | P2_missing_practice_support | 0 | 3 |
| 9 | Trigonometry Spire | P3_teacher_review_backlog | 0 | 0 |

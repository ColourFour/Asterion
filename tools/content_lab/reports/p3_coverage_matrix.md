...
- `P2_missing_practice_support`: 0
- `P3_teacher_review_backlog`: 0
- `P4_polish_or_complete`: 40
...
| p3_de_separation_setup | Differential equations | Differential Shrine | ready_for_review | 4 | healthy_evidence_count | 0 | none | P4_polish_or_complete | Teacher review can confirm this row for region-by-region correction planning. |
...
- Deferred case count: 0
- Affected skill count: 0
- Mastery evidence allowed: none
- Practice allowed: none
- Export allowed: none
...
| ---: | --- | --- | ---: | ---: |
| 1 | Algebra Vault | P4_polish_or_complete | 0 | 0 |
